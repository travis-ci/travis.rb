      ...
      class S3 < Service
        ...
        def run
          deploy 's3', 'push' do |config|
            ...
            config['acl'] = ask("S3 ACL Settings (private, public_read, public_read_write, authenticated_read, bucket_owner_read, bucket_owner_full_control): ") { |q| q.default = 'private'}
